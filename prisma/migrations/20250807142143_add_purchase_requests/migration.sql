...
-- CreateTable
CREATE TABLE `LostDamagedItem` (
    `lostDamagedId` INTEGER NOT NULL AUTO_INCREMENT,
    ...
    PRIMARY KEY (`lostDamagedId`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `PurchaseRequest` (
    `purchaseRequestId` INTEGER NOT NULL AUTO_INCREMENT,
    `title` VARCHAR(191) NOT NULL,
    `author` VARCHAR(191) NOT NULL,
    `isbn` VARCHAR(191) NULL,
    `subject` VARCHAR(191) NULL,
    ...
    `preferredVendor` VARCHAR(191) NULL,
...
-- AddForeignKey
ALTER TABLE `LostDamagedItem` ADD CONSTRAINT `LostDamagedItem_itemId_fkey` FOREIGN KEY (`itemId`) REFERENCES `Item`(`itemId`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `PurchaseRequest` ADD CONSTRAINT `PurchaseRequest_patronId_fkey` FOREIGN KEY (`patronId`) REFERENCES `Patron`(`patronId`) ON DELETE RESTRICT ON UPDATE CASCADE;
