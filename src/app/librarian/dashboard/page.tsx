    ...
    <div className="space-y-6 p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 flex items-center gap-2">
          ...
          Live library management system overview
          {lastUpdated && (
            <span className="text-sm text-green-600">
              • Auto-updating every 10 seconds • Last updated: {formatDate(lastUpdated)}
            </span>
          )}
        </p>
      </div>
                ...
                popularBooks.map((book, index) => (
                  <div key={book.itemId} className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                    ...
                    <div className="text-right">
                      <p className="text-sm font-medium">{book.timesLost} loans</p>
                      <p className="text-xs text-gray-500">
